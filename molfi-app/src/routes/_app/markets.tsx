  ...
  head: () => ({
    meta: [
      { title: pageTitle("Markets") },
      {
        name: "description",
        content:
          "Browse live prediction markets — crypto settled on-chain on Avalanche, plus sports, politics, and more.",
      },
    ],
  }),
    ...
    <section className={pageSimple}>
      ...
      {!comingSoon ? (
        <p className="flex items-center gap-1.5 rounded-lg border border-border bg-card/60 px-3 py-2 text-xs text-muted-foreground">
          ...
          settled by the live Chainlink oracle. Bets are transparent on-chain; the order-book depth is indicative.
        </p>
      ) : null}
